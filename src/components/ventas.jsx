...
const Ventas = () => {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#000", color: "#fff", fontFamily: "Arial, sans-serif" }}>
      ...
      {/* Navbar */}
      <nav style={{ background: "#000", borderBottom: "1px solid #222", padding: "20px" }}>
        <div style={{ maxWidth: "1400px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <a href="/home" style={{ fontSize: "28px", fontWeight: "bold", color: "#fff", textDecoration: "none" }}>
            URBAN CAPS
          </a>
          <a href="/home" style={{ background: "#111", color: "#fff", padding: "12px 24px", borderRadius: "6px", textDecoration: "none", border: "1px solid #222" }}>
            ← Volver
          </a>
        </div>
      </nav>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 20px" }}>
        ...
        <div style={{ background: "#111", border: "1px solid #222", borderRadius: "12px", padding: "32px" }}>
          ...
          {success && (
            <div style={{ background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.3)", padding: "16px", borderRadius: "6px", marginBottom: "24px", display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "12px", marginBottom: "12px" }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-end" }}>
                <button
                  ...
                  disabled={loading}
                  style={{ background: loading ? "#374151" : "#3b82f6", color: "#fff", border: "none", padding: "14px 28px", borderRadius: "6px", cursor: loading ? "not-allowed" : "pointer", fontWeight: "600", fontSize: "14px", width: "100%" }}
                >
          ...
          {loading && ventas.length === 0 ? (
            ...
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", background: "#000", borderRadius: "8px", overflow: "hidden" }}>
                <thead>
                  <tr>
                    {["ID VENTA", "ID USUARIO", "FECHA", "ACCIONES"].map((col) => (
                      <th key={col} style={{ background: "#1a1a1a", padding: "16px", textAlign: "left", fontWeight: "700", fontSize: "14px", borderBottom: "2px solid #222" }}>
                        {col}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                  {ventas.map((venta) => (
                    <tr key={venta.id_venta}>
                      <td style={{ padding: "16px", borderBottom: "1px solid #222" }}>#{venta.id_venta}</td>
                      <td style={{ padding: "16px", borderBottom: "1px solid #222" }}>👤 Usuario {venta.id_usuario}</td>
                      <td style={{ padding: "16px", borderBottom: "1px solid #222" }}>📅 {formatDate(venta.fecha)}</td>
                      <td style={{ padding: "16px", borderBottom: "1px solid #222" }}>
                        <div style={{ display: "flex", gap: "8px" }}>
                          <button
                            onClick={() => setEditingVenta({ ...venta })}
                            style={{ background: "#111", border: "1px solid #222", borderRadius: "6px", width: "36px", height: "36px", cursor: "pointer", fontSize: "16px" }}
                            title="Editar"
                          >
                            ✏️
                          </button>
          ...
          >
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <input
                ...
                disabled={loading}
                style={{ background: "#000", border: "1px solid #222", borderRadius: "6px", padding: "14px 16px", color: "#fff", fontSize: "14px", width: "100%", outline: "none" }}
              />
            </div>
        ...
        >
          ...
          >
            ...
            <p style={{ color: "#999", marginBottom: "24px", lineHeight: "1.6" }}>
              ...
              <strong style={{ color: "#fff" }}>#{deletingVenta.id_venta}</strong>?
              <br /><br />

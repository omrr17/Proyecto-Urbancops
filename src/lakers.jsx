  ...
  return (
    <div>
      ...
      <section className="container my-5 text-center">
        ...
        <p>
          Los Angeles Lakers son uno de los equipos más icónicos de toda la
          NBA. Tienen millones de fans en el mundo por su historia llena de
          títulos, leyendas como Kobe Bryant, Magic Johnson y ahora LeBron
          James. Por eso hay tantas gorras de los Lakers: no solo son parte del
          deporte, también son moda, cultura y actitud. Llevar una gorra de los
          Lakers es llevar la vibra de Los Ángeles.
        </p>

        <div className="row justify-content-center mt-4">
          {[
            {
              nombre: "Lakers Classic",
              precio: 95000,
              imagen: "../img/Lakers/2-removebg-preview.png",
              desc: "Gorra New Era 59FIFTY de la colección NBA Classic de Los Angeles Lakers.",
            },
            {
              nombre: "Lakers Black",
              precio: 92000,
              imagen: "../img/Lakers/1-removebg-preview.png",
              desc: "Gorra de los Lakers en color negro con logotipo bordado premium.",
            },
            {
              nombre: "Lakers Logo",
              precio: 98000,
              imagen: "../img/Lakers/3-removebg-preview.png",
              desc: "Modelo oficial de los Lakers con detalles clásicos y bordado icónico.",
            },
            {
              nombre: "Lakers Edition 1",
              precio: 95000,
              imagen: "../img/Lakers/4-removebg-preview.png",
              desc: "Gorra oficial de Los Angeles Lakers con diseño clásico New Era.",
            },
            {
              nombre: "Lakers Edition 2",
              precio: 92000,
              imagen: "../img/Lakers/5-removebg-preview.png",
              desc: "Gorra New Era de los Lakers con bordado premium.",
            },
            {
              nombre: "Lakers Edition 3",
              precio: 98000,
              imagen: "../img/Lakers/6-removebg-preview.png",
              desc: "Modelo clásico de Los Angeles Lakers con detalles bordados oficiales.",
            },
            {
              nombre: "Lakers Edition 4",
              precio: 95000,
              imagen: "../img/Lakers/7-removebg-preview.png",
              desc: "Gorra New Era oficial de la colección NBA Classic de Los Angeles Lakers.",
            },
            {
              nombre: "Lakers Edition 5",
              precio: 92000,
              imagen: "../img/Lakers/8-removebg-preview.png",
              desc: "Gorra premium de Los Angeles Lakers con acabado de alta calidad.",
            },
            {
              nombre: "Lakers Edition 6",
              precio: 98000,
              imagen: "../img/Lakers/9-removebg-preview.png",
              desc: "Modelo exclusivo de los Lakers con detalles bordados icónicos.",
            },
          ].map((item, index) => (
